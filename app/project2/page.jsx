...
const page = () => {
  return <div className="min-h-screen">
    <h1 className={`text-[3rem] p-3 text-center ${libre}`}>
        ...
        <Link target="_blank" href='https://github.com/AmeerMuaviya/Shoaib-Academy' className="rounded-xl bg-black hover:bg-gradient-to-tr flex items-center w-52 mx-auto text-center hover:from-teal-400 hover:to-blue-500 px-5 py-2">View on GitHub <ArrowUp /></Link>
